 ...
 Code Tested by: Ruiqi Lin,  Yueyang Chen
 Code Debugged by: Jianyu Zhang, Akshita Ambati
 */
...
public class ProgramToAccessDatabase {
    ...
    static final String DB_URL = "jdbc:mysql://localhost:3306/SE1?user=root&password=root";
     ...
     //   int week3_neg_exercise = 0;
       ...
       // int week4_neg_exercise = 0;
        ...
        try {
            ...
            rs = stmt1.executeQuery("SELECT TweetID,TweetText,CreateTime,UserID FROM SE1.twitter2");
