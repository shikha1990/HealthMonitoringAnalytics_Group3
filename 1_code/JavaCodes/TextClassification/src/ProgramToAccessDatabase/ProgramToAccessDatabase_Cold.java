 ...
 Code Modification done by: Yueyang Chen, Shikha Kakar
 Code Tested by: Akshita Ambati, Harika Matta
 Code Debugged by: Jianyu Zhang, Ruiqi Lin, 
 */
...
public class ProgramToAccessDatabase_Cold {
    ...
    static final String DB_URL = "jdbc:mysql://localhost:3306/SE2?user=root&password=root";
     ...
     //   int week3_neg_exercise = 0;
       ...
       // int week4_neg_exercise = 0;
        ...
        try {
            ...
            rs = stmt1.executeQuery("SELECT TweetID,TweetText,CreateTime,UserID FROM SE2.cold");
