 /*
 Code referenced from the LingPipe Github
 Code Modification done by: Ruiqi Lin, Yueyang Chen, 
 Code Tested by: Harika Matta, Jianyu Zhang,
 Code Debugged by: Shikha Kakar, Akshita Ambati
 */
...
public class ProgramToAccessDatabase_Warm {
    ...
    static final String DB_URL = "jdbc:mysql://localhost:3306/SE3?user=root&password=root";
     ...
     //   int week3_neg_exercise = 0;
       ...
       // int week4_neg_exercise = 0;
        ...
        try {
            ...
            rs = stmt1.executeQuery("SELECT TweetID,TweetText,CreateTime,UserID FROM SE3.warm");
