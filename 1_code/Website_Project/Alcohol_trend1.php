...
//Week 1 Alcohol data****************************************************
$sql = "SELECT `pos_alcohol` FROM `histogram2` WHERE week = '1'";
...
//Week 4 Alcohol************************************************************
$sql = "SELECT `pos_alcohol` FROM `histogram2` WHERE week = '4'";
$result = mysqli_query($conn, $sql);
// output data of each row
...
$b2plot->SetLegend('People doing #Exercise - #gym working out to stay in shape');

$b3plot->SetColor("white");
$b3plot->SetFillColor("#ee1289");
$b3plot->SetLegend('People doing #Exercise - #gym working out to stay in shape');


$b4plot->SetColor("white");
$b4plot->SetFillColor("#6600ff");
$b4plot->SetLegend('People doing #Exercise - #gym working out to stay in shape');

$graph->title->Set("Weekly Alcohol & Smoking Trends");
$graph->legend->SetFrameWeight(1);
$graph->legend->SetPos(0.05,0.1, 'right', 'center');
