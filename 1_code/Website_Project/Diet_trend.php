...
//Week 1 diet data****************************************************
$sql = "SELECT `pos_diet` FROM `histogram2` WHERE week = '1'";
...
$sql = "SELECT `neg_diet` FROM `histogram2` WHERE week = '1'";  
$result = mysqli_query($conn, $sql);
//output data of each row
$row1_negdiet = mysqli_fetch_assoc($result);
$week1_negdiet= $row1_negdiet['neg_diet'];

$sql = "SELECT `mot_diet` FROM `histogram2` WHERE week = '1'";
$result = mysqli_query($conn, $sql);
// output data of each row
...
//Week 3 diet**********************************************************
$sql = "SELECT `pos_diet` FROM `histogram2` WHERE week = '3'";
$result = mysqli_query($conn, $sql);
// output data of each row
...
$sql = "SELECT `neg_diet` FROM `histogram2` WHERE week = '3'";  
$result = mysqli_query($conn, $sql);
// output data of each row
...
$sql = "SELECT `mot_diet` FROM `histogram2` WHERE week = '3'";
$result = mysqli_query($conn, $sql);
// output data of each row
...
//Week 4 diet************************************************************
$sql = "SELECT `pos_diet` FROM `histogram2` WHERE week = '4'";
$result = mysqli_query($conn, $sql);
// output data of each row
...
$sql = "SELECT `neg_diet` FROM `histogram2` WHERE week = '4'";  
$result = mysqli_query($conn, $sql);
// output data of each row
...
$sql = "SELECT `mot_diet` FROM `histogram2` WHERE week = '4'";
$result = mysqli_query($conn, $sql);
// output data of each row
...
$b1plot->SetLegend('People doing #Healthy Diet - Loved the veggie salad #healthyfood');
$b1plot->value->Show();

$b3plot->SetColor("white");
$b3plot->SetFillColor("#1c86ee");
$b3plot->SetLegend('People asking for #HealthyDiet #Motivation - Eating pretzels #ishealthy#confused');
$b3plot->value->Show();

$b2plot->SetColor("white");
$b2plot->SetFillColor("#ff4040");  
$b2plot->SetLegend('People following #UnhealthyDiet - On a eating spree #cheese #pizza');
$b2plot->value->Show();

$graph->title->Set("Weekly Diet Trends");
$graph->legend->SetFrameWeight(1);
$graph->legend->SetPos(0.02,0.85, 'centre');
