...
//Week 1 Alcohol data****************************************************
$sql = "SELECT `pos_alcohol` FROM `histogram6` WHERE week = '1'";
...
//Week 4 Alcohol************************************************************
$sql = "SELECT `pos_alcohol` FROM `histogram6` WHERE week = '4'";
$result = mysqli_query($conn, $sql);
// output data of each row
...
$b1plot->SetLegend('pos_alcohol');
$b1plot->value->Show();

$b2plot->SetColor("white");
$b2plot->SetFillColor("#1c86ee");
$b2plot->SetLegend('quit_alcohol');
$b2plot->value->Show();

$b3plot->SetColor("white");
$b3plot->SetFillColor("#ee1289");
$b3plot->SetLegend('pos_smoking');
$b3plot->value->Show();


$b4plot->SetColor("white");
$b4plot->SetFillColor("#6600ff");
$b4plot->SetLegend('quit_smoking');
$b4plot->value->Show();

$graph->title->Set("Weekly Alcohol&Smoking Trends in Colder places");
