...
$sql = "SELECT `pos_exercise` FROM `histogram6` WHERE week = '1'";
...
$sql = "SELECT `mot_exercise` FROM `histogram6` WHERE week = '1'";
$result = mysqli_query($conn, $sql);
// output data of each row
...
//Week 2 Exercise***********************************************************
$sql = "SELECT `pos_exercise` FROM `histogram6` WHERE week = '2'";
$result = mysqli_query($conn, $sql);
// output data of each row
...
$sql = "SELECT `mot_exercise` FROM `histogram6` WHERE week = '2'";
$result = mysqli_query($conn, $sql);
// output data of each row
...
//Week 3 Exercise**********************************************************
$sql = "SELECT `pos_exercise` FROM `histogram6` WHERE week = '3'";
$result = mysqli_query($conn, $sql);
// output data of each row
...
$sql = "SELECT `mot_exercise` FROM `histogram6` WHERE week = '3'";
$result = mysqli_query($conn, $sql);
// output data of each row
...
//Week 4 Exercise************************************************************
$sql = "SELECT `pos_exercise` FROM `histogram6` WHERE week = '4'";
$result = mysqli_query($conn, $sql);
// output data of each row
...
$sql = "SELECT `mot_exercise` FROM `histogram6` WHERE week = '4'";
$result = mysqli_query($conn, $sql);
// output data of each row
...
$graph->title->Set("Weekly Exercise Trends in Colder places");
