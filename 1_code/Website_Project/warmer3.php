...
//Week 1 diet data****************************************************
$sql = "SELECT `pos_diet` FROM `histogram6` WHERE week = '1'";
...
$sql = "SELECT `neg_diet` FROM `histogram6` WHERE week = '1'";  
$result = mysqli_query($conn, $sql);
//output data of each row
$row1_negdiet = mysqli_fetch_assoc($result);
$week1_negdiet= $row1_negdiet['neg_diet'];

$sql = "SELECT `mot_diet` FROM `histogram6` WHERE week = '1'";
$result = mysqli_query($conn, $sql);
// output data of each row
...
//Week 3 diet**********************************************************
$sql = "SELECT `pos_diet` FROM `histogram6` WHERE week = '3'";
$result = mysqli_query($conn, $sql);
// output data of each row
...
$sql = "SELECT `neg_diet` FROM `histogram6` WHERE week = '3'";  
$result = mysqli_query($conn, $sql);
// output data of each row
...
$sql = "SELECT `mot_diet` FROM `histogram6` WHERE week = '3'";
$result = mysqli_query($conn, $sql);
// output data of each row
...
//Week 4 diet************************************************************
$sql = "SELECT `pos_diet` FROM `histogram6` WHERE week = '4'";
$result = mysqli_query($conn, $sql);
// output data of each row
...
$sql = "SELECT `neg_diet` FROM `histogram6` WHERE week = '4'";  
$result = mysqli_query($conn, $sql);
// output data of each row
...
$sql = "SELECT `mot_diet` FROM `histogram6` WHERE week = '4'";
$result = mysqli_query($conn, $sql);
// output data of each row
...
$graph->title->Set("Weekly Diet Trends in Colder Places");
